-- Insertar usuarios
INSERT INTO usuario (nombre_completo, email, telefono, password, es_administrador) VALUES
...
-- Insertar asientos (ejemplo para zona VIP del estadio)
...
INSERT INTO compra (id_usuario, id_evento, total, estado) VALUES
(1, 1, 230000.00, 'CONFIRMADA'),
(2, 2, 120000.00, 'PAGADA');

-- Insertar entradas para esas compras
INSERT INTO entrada (id_compra, id_zona, id_asiento, precio_final, estado) VALUES
(1, 1, 1, 150000.00, 'ACTIVA'),
(1, 1, 2, 150000.00, 'ACTIVA'),
(2, 4, NULL, 120000.00, 'ACTIVA'); -- asiento NULL porque no es numerado

-- Insertar servicios adicionales para compras
INSERT INTO compra_servicio (id_compra, id_servicio) VALUES
(1, 1), -- VIP para compra 1
(1, 2); -- Seguro para compra 1